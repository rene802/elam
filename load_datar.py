...
print()
# Background, Prompt, Non_prompt lenght before cuts and equalization events in each category
print(f"Background, Prompt, Non_prompt lenght before cuts and equalization events in each category :\n")
print("Background :", len(Background))
print("Prompt :", len(Prompt))
print("NonPrompt :", len(Non_Prompt))
print()

# Application of fPt cut on the three categories for training and fitting
#pt_cut = "fPt > 1 and fPt < 5"
#print(f"cuts sideband :\n", pt_cut)
...
#print(f"minimum events throught bkg, prompt, nprompt :\n")
...
output_file = os.path.join(model_dir, "train_test_data.pkl")
pickle.dump(train_test_data, open(output_file, "wb"))
print()
# Background, Prompt, Non_prompt lenght after cuts and equalization events in each category
print(f"Background, Prompt, Non_prompt lenght after cuts and equalization events in each category :\n")
print("Background :", len(Background))
print("Prompt :", len(Prompt))
print("NonPrompt :", len(Non_Prompt))

print()
print(f"display respectively of bkg, prompt, nprompt number of training labels and testing labels :\n" )
