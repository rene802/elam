...
model_hdl.load_model_handler(os.path.join(model_dir, "model_r.pkl"))
...
if not os.path.exists(parquet_file):
    ...
    handler.write_df_to_parquet_files(os.path.join(model_dir, "r_output"))
    print("\nParquet created.\n")


# creation of parquet file for test data
test_parquet = os.path.join(model_dir,"testr_output_templates.parquet.gzip")
if not os.path.exists(test_parquet):
    ...
    test_hdl.write_df_to_parquet_files(os.path.join(model_dir, "testr_output"))
